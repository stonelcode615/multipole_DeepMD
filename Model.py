...
class PrimitiveMomentModel(TensorModel):
    def __init__(self, jdata, descrpt, fitting) :
        TensorModel.__init__(self, jdata, descrpt, fitting, 'primitivemoment')

class MomentModel(TensorModel):
    def __init__(self, jdata, descrpt, fitting) :
        TensorModel.__init__(self, jdata, descrpt, fitting, 'moment')

class DipolestoneModel(TensorModel):
    def __init__(self, jdata, descrpt, fitting) :
        TensorModel.__init__(self, jdata, descrpt, fitting, 'dipolestone')
