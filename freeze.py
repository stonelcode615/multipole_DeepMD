...
def _make_node_names(model_type = None) : 
    ...
    elif model_type == 'primitivemoment':
        nodes = "o_primitivemoment,descrpt_attr/rcut,descrpt_attr/ntypes,model_attr/tmap,model_attr/sel_type,model_attr/model_type"
    elif model_type == 'moment':
        nodes = "o_moment,descrpt_attr/rcut,descrpt_attr/ntypes,model_attr/tmap,model_attr/sel_type,model_attr/model_type"
    elif model_type == 'dipolestone':
        nodes = "o_dipolestone,descrpt_attr/rcut,descrpt_attr/ntypes,model_attr/tmap,model_attr/sel_type,model_attr/model_type"
